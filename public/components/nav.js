    ...
    <div class="flex h-16 justify-between">
      <div class="flex items-center px-2 lg:px-0">
        ...
        <div id="mySidenav" class="sidenav z-40 flex flex-col">
          ...
          <a href="//erp.stokdirect.africa/login#login" class="text-white hover:text-gray-200"><span>Register</span></a>
        </div>
      </div>
      <div class="lg:flex flex-1 hidden items-center justify-center px-2 lg:ml-6 lg:justify-end">
        <div class="max-w-lg lg:max-w-md flex items-center justify-evenly w-full">
          ...
          <a href="//erp.stokdirect.africa/register/new" class="py-2 px-4 rounded-md flex items-center bg-[#E2BF17]"><span>Register</span></a>
        </div>
      </div>
